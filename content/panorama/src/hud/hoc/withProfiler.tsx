...
const onRender = (id: any, phase: any, actualTime: any, baseTime: any, startTime: any, commitTime: any) => {
  $.Msg(`${id}'s ${phase} phase - Actual time: ${actualTime} | Base time: ${baseTime} | Start time: ${startTime} | Commit time: ${commitTime}`);
}
...
const withProfiler = <P extends object>(Component: React.ComponentType<P>) => class WithProfiler extends React.Component<P> {
