...
import { InternalPanel, queueMicrotask } from './utils'
...
const propertiesInformation: {
	...
	dialogVariables: {
		...
		update(panel, newValue = {}, oldValue = {}) {
			$.Msg('dialogVariables.update called')
...
definePanelPropertyInformation('Image', {
	...imageAttributes,
})
...
definePanelPropertyInformation('AnimatedImageStrip', {
...
definePanelPropertyInformation('ProgressBar', {
	...progressBarAttributes,
})

definePanelPropertyInformation('CircularProgressBar', {
	...progressBarAttributes,
})
...
definePanelPropertyInformation('DOTAUserName', {
	steamid: steamIdAttribute,
})

definePanelPropertyInformation('DOTAUserRichPresence', {
	steamid: steamIdAttribute,
})
...
definePanelPropertyInformation('Slider', {
	...sliderAttributes,
})
...
export function splitInitialProps(type: PanelType, props: Record<string, any>) {
	...
	return {
		initialProps: hasInitialProps ? initialProps : undefined,
		otherProps,
	}
}

export function updateProperty(type: PanelType, panel: InternalPanel, propName: string, oldValue: any, newValue: any) {
