...
const Health = () => {
	...
	return (
		<Panel className={Styles.container}>
			...
			<Label className={Styles.healthLabel} text={`${health}/${maxHealth}`} />
			<Label className={Styles.regenLabel} style={{ color: isEnemy ? '#ff4433' : '#3ED038' }} text={`+ ${healthRegen.toFixed(1)}`} />
		</Panel>
	)
}
